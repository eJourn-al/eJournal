...
def update_with_launch_data(user, message_launch_data):
    ...
    user.username = message_launch_data.get(lti.claims.CUSTOM).get('username', user.username)
    ...
    get_or_create_participation_with_launch_data(user, message_launch_data)
