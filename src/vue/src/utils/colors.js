...
export default {
    ...
    randomBrightHSLcolor () {
        ...
        const lighnessCeil = 0.5
        const lightness = Math.random() * (lighnessCeil - lightnessFloor) + lightnessFloor
    ...
    getThemeOrRandomColor (index) {
        ...
        if (index < selectedThemeColors.length) {
            return selectedThemeColors[index]
        }

        return (this.randomBrightRGBcolor())
    },
}
